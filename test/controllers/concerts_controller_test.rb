...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { artist: @concert.artist, cost: @concert.cost, date: @concert.date, finish_time: @concert.finish_time, start_time: @concert.start_time }
    end
  ...
  test "should update concert" do
    patch :update, id: @concert, concert: { artist: @concert.artist, cost: @concert.cost, date: @concert.date, finish_time: @concert.finish_time, start_time: @concert.start_time }
    assert_redirected_to concert_path(assigns(:concert))
  end
